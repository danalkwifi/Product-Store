                ...
                return (
                    <div key={item.id} className='border-3 rounded-xl border-blue-300 m-3 p-3 hover:border-blue-500' > 
                        <img className='w-full object-cover h-48 border-0 rounded-xl' src={item.image} alt={item.name} />
                            {edit ? (
                                <div className='flex flex-row justify-center items-center p-2'>
                                    ...
                                    />
                                    <button className='hover:cursor-pointer mx-3 text-2xl' onClick={() => handleUpdateName(item)}><FontAwesomeIcon icon={faSquareCheck} /></button>
                        ...
                        <div className='flex flex-row justify-between items-center p-2'>
                            ...
                            <button className='hover:cursor-pointer px-3' onClick={() => handleDescriptionUpdate(index)}><FontAwesomeIcon icon={faPenToSquare} /></button>
                        </div>
                    </div>
                )
            })
